    ...
    <section class="container mx-auto pt-8">
        ...
        <div class="w-full lg:max-w-full lg:flex mb-4">
          ...
          >
            <div>
              ...
              <p class="text-sm font-bold flex items-center mb-1">Short Description</p>
      ...
      <div class="block mb-2" v-if="transactions_history.data.length > 0">
        <div
          ...
          v-for="transaction in transactions_history.data"
          :key="transaction.id"
        >
          <div
          ...
          >
            <div>
              ...
              <p class="text-sm text-gray-600 flex items-center mb-2">
                Rp. {{ transaction.amount.toLocaleString("id-ID") }} &middot;
      ...
      <div class="block mb-2" v-else>
        <div class="w-full lg:max-w-full lg:flex mb-4">
          ...
          >
            <div>
              <div class="text-gray-900 font-bold text-xl mb-1">Belum Ada Transaksi</div>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  async asyncData({ $axios, params }) {
    ...
    const transactions_history = await $axios.$get(
