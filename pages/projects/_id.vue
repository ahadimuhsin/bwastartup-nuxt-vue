        ...
        <div class="w-3/4 mr-6">
          <div class="bg-white p-3 mb-3 border border-gray-400 rounded-20">
            <figure class="item-image">
              <img v-if="campaign.data.images.length > 0" :src="default_image" alt="" class="rounded-20 w-full" />
...
export default {
  ...
  methods:{
    ...
    async fund(){
      try {
        let response = await this.$axios.post('/api/v1/transaction', this.transactions);
